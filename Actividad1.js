...
//    let patronesABuscar = ["00", "101", "ABC", "HO"];
    ...
    // Recorremos el vector patronesABuscar
        ...
        texto = document.getElementsByName("text")[0].value;
        patronesABuscar = document.getElementsByName("patron")[0].value;
        alert(texto+" "+patronesABuscar);
