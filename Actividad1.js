...
function main() {
    ...
    let i;
    let repeticiones = prompt( "introduzca cuantos textos quires analizar" );
    ...
    for (i = 0; i < repeticiones; i++) {
        ...
        let patron =prompt( "Introduzca un patron" );
        // Buscamos el patron
        let res = buscarPatron(texto, patron);
        alert("El partron " + patron + " esta " + res + " veces");
        // Acumulamos el total
        total += res;
    }
