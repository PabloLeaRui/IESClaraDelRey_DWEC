...
function main() {
    ...
    let cuantosPatrone = prompt("Patrones a buscar");
    let patronesABuscar = [] ;

    for (let index = 0; index <cuantosPatrone; index++) {
        
        patronesABuscar[index] = prompt("Patron numero " + (index+1));
        
    }

    for (let i = 0; i < patronesABuscar.length; i++) {
